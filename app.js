const PROJECTS = {
  ...
  enjoy: {
    ...
    body: "<p><strong>Product.</strong> A live-dealer iGaming platform with real-time games — including titles like Wonder Wheel — streamed from custom studios and optimized for desktop and mobile.</p><p><strong>What I owned.</strong> Refactored the core game architecture by moving shared UI components and business logic into reusable libraries, making new game development faster and more consistent. Worked with product and design to shape feature requirements and ship updates to live games already running in production. Implemented GSAP-based animations for live game interfaces.</p>",
    highlights: [
      "Refactored core game architecture into reusable libraries",
      "Worked with product and design on feature requirements",
      "Implemented GSAP-based animations",
    ],
    links: [
